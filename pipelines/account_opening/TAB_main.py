...
conv_acct_script = sys_path + "scripts/TAB_account_opening.sql"

etl_starttime = datetime.now()
print(f"TAB ETL started at at - {etl_starttime}")
...
try:
    destination_cursor.execute("Truncate table TAB_AccountOpening")
...
try:
    ...
    table_name = "TAB_AccountOpening"  # Table name
...
print(f"TAB ETL completed at at - {etl_endtime}")
